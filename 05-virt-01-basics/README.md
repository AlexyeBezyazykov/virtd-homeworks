...
Объясните критерии выбора платформы в каждом случае.
      ...
      Я бы выбрал физический сервер, либо аппаратную виртуализацию, поскольку максимум ресурсов можно выделить для ВМ и при этом обеспечить отказоустойчивость и резевное копирование.
